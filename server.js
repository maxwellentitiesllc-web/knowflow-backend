...
// CORS — allow Netlify, Vercel, and localhost
app.use(cors({
  origin: function(origin, callback) {
    ...
    // Allow any Netlify or Vercel subdomain
    var isNetlify = /\.netlify\.app$/.test(origin);
    var isVercel  = /\.vercel\.app$/.test(origin);
    var isAllowed = allowed.indexOf(origin) !== -1 || isNetlify || isVercel;
